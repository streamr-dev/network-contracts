...
interface ERC721JoinPolicyInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721JoinPolicy extends Contract {
  ...
  interface: ERC721JoinPolicyInterface;
  ...
  callStatic: {
    ...
    depositStake(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    withdrawStake(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
