...
interface ERC1155PolicyDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155PolicyDeployer extends Contract {
  ...
  interface: ERC1155PolicyDeployerInterface;
  ...
  functions: {
    ...
    deploy(
      tokenAddress: string,
      streamId_: string,
      minRequiredBalance_: BigNumberish,
