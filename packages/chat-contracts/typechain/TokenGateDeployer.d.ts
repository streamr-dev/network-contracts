...
interface TokenGateDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenGateDeployer extends Contract {
  ...
  interface: TokenGateDeployerInterface;
