...
interface ERC20PolicyDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20PolicyDeployer extends Contract {
  ...
  interface: ERC20PolicyDeployerInterface;
