...
interface ERC777PolicyDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC777PolicyDeployer extends Contract {
  ...
  interface: ERC777PolicyDeployerInterface;
