...
const STREAMREGISTRYADDRESS = '0xb779D34780ea23f7B73D875050f6b257F27Aa2D0'
const ENSCACHEADDRESS = '0xC928822c605E6ccc09D37498D00bD9ceB42b3690'
...
const triggerChainlinkSyncOfENSNameToSidechain = async () => {
    ...
    const randomPath = getRandomPath()
    tx = await registryFromAdmin.createStreamWithENS(randomENSName, randomPath, metadata1)
