...
export declare namespace StreamRegistryV3 {
...
export interface StreamRegistryV3Interface extends utils.Interface {
  contractName: "StreamRegistryV3";
  functions: {
    ...
    "trustedSetPermissions(string[],address[],(bool,bool,uint256,uint256,bool)[])": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [string, string[], StreamRegistryV3.PermissionStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [string[], string[], string[], StreamRegistryV3.PermissionStruct[]]
  ): string;
  encodeFunctionData(
...
export interface StreamRegistryV3 extends BaseContract {
  contractName: "StreamRegistryV3";
  ...
  functions: {
    ...
    getDirectPermissionsForUser(
      ...
      [StreamRegistryV3.PermissionStructOutput] & {
        permission: StreamRegistryV3.PermissionStructOutput;
      }
    >;
    ...
    setPermissions(
      streamId: string,
      users: string[],
      permissions: StreamRegistryV3.PermissionStruct[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  getDirectPermissionsForUser(
    ...
    user: string,
    overrides?: CallOverrides
  ): Promise<StreamRegistryV3.PermissionStructOutput>;
