...
export interface StreamRegistryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, string[], StreamRegistry.PermissionStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [string[], string[], string[], StreamRegistry.PermissionStruct[]]
  ): string;
  encodeFunctionData(
...
export interface StreamRegistry extends BaseContract {
  ...
  functions: {
    ...
    getDirectPermissionsForUser(
      ...
      [StreamRegistry.PermissionStructOutput] & {
        permission: StreamRegistry.PermissionStructOutput;
      }
    >;
    ...
    setPermissions(
      streamId: string,
      users: string[],
      permissions: StreamRegistry.PermissionStruct[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  getDirectPermissionsForUser(
    ...
    user: string,
    overrides?: CallOverrides
  ): Promise<StreamRegistry.PermissionStructOutput>;
