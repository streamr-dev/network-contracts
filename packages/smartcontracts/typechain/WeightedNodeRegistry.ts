...
export interface WeightedNodeRegistryInterface extends utils.Interface {
  contractName: "WeightedNodeRegistry";
  functions: {
    ...
    "initialize(address,bool,address,address[],string[])": FunctionFragment;
    ...
    "setWeightStrategy(address)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [string, boolean, string, string[], string[]]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setWeightStrategy",
    values: [string]
  ): string;
...
export interface WeightedNodeRegistry extends BaseContract {
  contractName: "WeightedNodeRegistry";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WeightedNodeRegistryInterface;
  ...
  functions: {
    ...
    "initialize(address,bool,address,address[],string[])"(
      owner_: string,
      requiresWhitelist_: boolean,
      weightStrategy_: string,
      initialNodes: string[],
      initialUrls: string[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
