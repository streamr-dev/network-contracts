...
const ENSCacheV1 = "0x870528c1aDe8f5eB4676AA2d15FC0B034E276A1A"

// const domainOwner = new Wallet(DEFAULTPRIVATEKEY, mainnetProvider)
const domainOwnerSidechain = new ethers.Wallet(DEFAULTPRIVATEKEY, sideChainProvider)
...
const connectToAllContracts = async () => {
    ...
    const streamregistryFactory = await ethers.getContractFactory("StreamRegistryV4", domainOwnerSidechain)
