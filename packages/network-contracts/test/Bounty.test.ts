...
describe("Bounty", (): void => {
    ...
    describe("IJoinPolicy failures", (): void => {
        ...
        it("negativetest error setting param on joinpolicy no revert reason", async function(): Promise<void> {
    ...
    describe("IAllocationPolicy failures", (): void => {
