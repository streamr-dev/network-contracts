...
jq .abi ../network-contracts/artifacts/contracts/OperatorTokenomics/BrokerPool.sol/BrokerPool.json > abis/BrokerPool.json
jq .abi ../network-contracts/artifacts/contracts/OperatorTokenomics/BrokerPoolFactory.sol/BrokerPoolFactory.json > abis/BrokerPoolFactory.json
