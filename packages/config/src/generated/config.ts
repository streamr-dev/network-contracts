...
export const config = {
    dev0: {
        ...
        contracts: {
            ...
            Uniswap2AdapterForMarketplaceV3:
                '0xDbcdfB708A006A9AebC592C4520289cD87a95938',
    ...
    dev1: {
        ...
        contracts: {
            ...
            SponsorshipDefaultLeavePolicy:
                '0xa2338F8be0941B361baBebb01ab8da5725CF0a33',
            SponsorshipMaxOperatorsJoinPolicy:
                '0x2521E0480004056c35e199a1BBE2FdA9119032A0',
            SponsorshipOperatorContractOnlyJoinPolicy:
                '0xd8F0a63e5EB661695620c92af5d981D18d5a484E',
            SponsorshipStakeWeightedAllocationPolicy:
                '0xef927F18D2ac3862c6ABCAa953203A4DbF7f519e',
            SponsorshipVoteKickPolicy:
                '0x0617466e5bC15027c604A56E35b172E06d689E4f',
            OperatorFactory: '0xcb5bCb343218044C547AFdcBa2e50Ac728D0DcA3',
            OperatorDefaultDelegationPolicy:
                '0x03CF38C75BFb9F4466fBA0aEd95f2613B0D1bCA0',
            OperatorDefaultUndelegationPolicy:
                '0x67A0E9C9c21d11dB4eBAe420aBf705626a3a2561',
            OperatorDefaultExchangeRatePolicy:
                '0x252743660fACD52e7CEF851CEB1c133B58Fb526d',
        },
        theGraphUrl:
            'http://10.200.10.1:8000/subgraphs/name/streamr-dev/network-subgraphs',
    },
    dev2: {
        id: 31337,
        name: 'dev2',
        ...
        rpcEndpoints: [{ url: 'http://10.200.10.1:8547' }],
        adminPrivateKey:
        ...
        contracts: {
            ...
            SponsorshipOperatorContractOnlyJoinPolicy:
                '0x57B81a9442805f88c4617B506206531e72d96290',
            SponsorshipMaxOperatorsJoinPolicy:
                '0x699B4bE95614f017Bb622e427d3232837Cc814E6',
            SponsorshipStakeWeightedAllocationPolicy:
                '0xBc0c81a318D57ae54dA28DE69184A9c3aE9a1e1c',
            SponsorshipDefaultLeavePolicy:
                '0x611900fD07BB133016Ed85553aF9586771da5ff9',
            SponsorshipVoteKickPolicy:
                '0x256D4CB67452b6b8280B2b67F040fD22f1C378f4',
            SponsorshipFactory: '0xbfa4EcF9d107De5720446e6dd8162ef6bf4b3873',
            OperatorDefaultDelegationPolicy:
                '0xeE1bC9a7BFF1fFD913f4c97B6177D47E804E1920',
            OperatorDefaultExchangeRatePolicy:
                '0xD13D34d37e2c94cb35EA8D5DE7498Cb7830d26e0',
            OperatorDefaultUndelegationPolicy:
                '0x1Cc93b7f91727e7c9bC86025C622A664e93DFb29',
        ...
        theGraphUrl:
            'http://10.200.10.1:8800/subgraphs/name/streamr-dev/network-subgraphs',
        entryPoints: [
            {
                nodeId: 'eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
                websocket: { host: '10.200.10.1', port: 40500, tls: false },
            },
        ],
    },
    alfajores: {
        ...
        rpcEndpoints: [{ url: 'https://alfajores-forno.celo-testnet.org' }],
        contracts: {
    ...
    optGoerli: {
        ...
        rpcEndpoints: [{ url: 'https://goerli.optimism.io' }],
        contracts: {
    ...
    gnosis: {
        ...
        contracts: {
            ...
            Uniswap2AdapterForMarketplaceV3:
                '0xec92c5f94d45D1a4D917f2E07dD959b33e1AFe38',
    ...
    polygon: {
        ...
        contracts: {
            ...
            SponsorshipOperatorContractOnlyJoinPolicy:
                '0xa1F3c94A682Cb43d26AcC40dA1Dc31f49e4dA466',
            SponsorshipMaxOperatorsJoinPolicy:
                '0x27448061420bAccAE8c84DDC3E7e2e8B2aE4977E',
            SponsorshipStakeWeightedAllocationPolicy:
                '0x1Dd16E748308E9f259f3D6097d00e1793BfBdcDB',
            SponsorshipDefaultLeavePolicy:
                '0xa953D590098A3d56304a12A8e929D63748D90AAC',
            SponsorshipVoteKickPolicy:
                '0xeF3F567D7328849c1130CBCBF8Cd9feB42eA5dB5',
            ...
            Uniswap2AdapterForMarketplaceV3:
                '0x83C42F77c6dD09A1A93A7834be65b3bB891106bE',
        },
        blockExplorerUrl: 'https://polygonscan.com',
        theGraphUrl:
            'https://gateway-arbitrum.network.thegraph.com/api/a971cec07440a9ec63cd806c06ccc990/subgraphs/id/EGWFdhhiWypDuz22Uy7b3F69E9MEkyfU9iAQMttkH5Rj',
        entryPoints: [
            {
    ...
    polygonAmoy: {
        ...
        contracts: {
            ...
            SponsorshipOperatorContractOnlyJoinPolicy:
                '0x930Dcc2ca313ACf7177185C0D68462fDc699C7e0',
            SponsorshipMaxOperatorsJoinPolicy:
                '0xd640C2C5102953d122759826daa6Aec25eC98ca5',
            SponsorshipStakeWeightedAllocationPolicy:
                '0xaC80c738FCF8d259F07C82eAD68B75aF4DF82223',
            SponsorshipDefaultLeavePolicy:
                '0x16Ba0F2793Da54b67717c6bAD471624C6628F2aa',
            SponsorshipVoteKickPolicy:
                '0xA73aDbEC14be2D3628CeAD022243f080CB162955',
            SponsorshipFactory: '0xb194a68b166f2e3074B551393fA61490D19c69f8',
            OperatorDefaultDelegationPolicy:
                '0x78f29fF290148e83795393f1858DC540D8cB046b',
            OperatorDefaultExchangeRatePolicy:
                '0x48d25dd5731AD644613b67E4281C505Ef392Dd70',
            OperatorDefaultUndelegationPolicy:
                '0x7962155D5ea2fF949FCF300F221964d5ef9d1bad',
            ...
            DataUnionFactory: '0x62d48EBcf518AF1eb4c647721a19B046810623c4',
            DataUnionTemplate: '0xACe6B50B1d1Fb06b4650eF4Adb094747C65Ab674',
    ...
    peaq: {
        id: 3338,
        name: 'Peaq EVM chain',
        nativeCurrency: { symbol: 'PEAQ', name: 'PEAQ', decimals: 18 },
        rpcEndpoints: [{ url: 'https://peaq.api.onfinality.io/public' }],
        contracts: {
            ...
            SponsorshipOperatorContractOnlyJoinPolicy:
                '0xF655955dc561356851e95a6D0febeB0BAc955Ab5',
            SponsorshipMaxOperatorsJoinPolicy:
                '0xE41439BF434F9CfBF0153f5231C205d4ae0C22e3',
            SponsorshipStakeWeightedAllocationPolicy:
                '0xC8E8efAF4CE7bCcFc87878631BC64A1FAe63dc5D',
            SponsorshipDefaultLeavePolicy:
                '0xDa579a9a55158Bc57389f1b05F553DEf38a121c1',
            SponsorshipVoteKickPolicy:
                '0xdc8d23092b93F9BB7416F45dEa36f55996f34867',
            SponsorshipFactory: '0xdaF0905e19C45b9Fea7E60D232061edF78E9F570',
            OperatorDefaultDelegationPolicy:
                '0xD3329a2FC8194f0F96749275FF5162f7f2F031F7',
            OperatorDefaultExchangeRatePolicy:
                '0xA3D82B569ab0dEF86935fCf4e7714626a608CF81',
            OperatorDefaultUndelegationPolicy:
                '0x3EF89eF888721446Cf373C5070399B8225C9E936',
