...
module.exports = {
    ...
    dependencyCompiler: {
        paths: [
            ...
            '@streamr-contracts/network-contracts/contracts/chainlinkClient/ENSCacheV2Streamr.sol',
            '@streamr-contracts/network-contracts/contracts/StreamStorageRegistry/StreamStorageRegistryV2.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/StreamrConfig.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/SponsorshipPolicies/MaxOperatorsJoinPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/SponsorshipPolicies/StakeWeightedAllocationPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/SponsorshipPolicies/DefaultLeavePolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/SponsorshipPolicies/VoteKickPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/OperatorPolicies/DefaultDelegationPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/OperatorPolicies/DefaultPoolYieldPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/OperatorPolicies/DefaultUndelegationPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/Sponsorship.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/SponsorshipFactory.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/Operator.sol',
            '@streamr-contracts/network-contracts/contracts/OperatorTokenomics/OperatorFactory.sol',
