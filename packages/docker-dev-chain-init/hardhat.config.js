...
module.exports = {
    ...
    dependencyCompiler: {
        paths: [
            ...
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/StreamrConfig.sol',
            ...
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BountyPolicies/VoteKickPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BrokerPoolPolicies/DefaultPoolJoinPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BrokerPoolPolicies/DefaultPoolYieldPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BrokerPoolPolicies/DefaultPoolExitPolicy.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/Bounty.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BountyFactory.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BrokerPool.sol',
            '@streamr-contracts/network-contracts/contracts/BrokerEconomics/BrokerPoolFactory.sol',
